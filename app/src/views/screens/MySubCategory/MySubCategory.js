...
function MySubCategory({ navigation }) {
// RBsheet
    ...
    >
      ...
      <Modal visible={visible1} onDismiss={hideModal}
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          >
          {
            ...
            //     >
            //       {
            //       activeColor==item && <Icon name="check" size={15} color={COLORS.white} />
            //     }
            //     </TouchableOpacity>
            //   )})
          }
      ...
      <Dialog visible={visibledel} onDismiss={hideDialog}>
            ...
            >
              ...
              >Deleting this Folder Will delete is Subfolders and Items</Paragraph>
            </Dialog.Content>
            <Dialog.Actions>
              <Button 
              color={COLORS.light}
